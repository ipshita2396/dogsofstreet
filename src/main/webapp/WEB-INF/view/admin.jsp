...
<h3>
<a href="<c:url value="/admin/EventList"/>">Event Inventory</a>
</h3>
<h3>
<a href="<c:url value="/admin/VolunteerList"/>">Volunteer Inventory</a>
</h3>
<h3>
<a href="<c:url value="/admin/adoptionList"/>">Adoption Inventory</a>
</h3>
</div>
</div>
</body>
